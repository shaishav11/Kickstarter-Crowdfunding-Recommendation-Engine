...
cat = st.sidebar.selectbox( 'Select the category of the project?', ('Art', 'Comics', 'Dance', 'Design', 'Fashion', 'Film & Video', 'Film &amp; Video', 'Food', 'Games', 'Music', 'Photography', 'Publishing', 'Technology', 'Theater'))
if cat=='Art': 
...
state = st.sidebar.selectbox( 'Select the state for your project?', ('AK', 'AL', 'AR', 'AZ', 'CA', 'CO', 'CT', 'DC', 'DE', 'FL', 'GA', 'HI', 'IA', 'ID', 'IL', 'IN', 'KS', 'KY', 'LA', 'MA', 'MD', 'ME', 'MI', 'MN', 'MO', 'MS', 'MT', 'NC', 'ND', 'NE', 'NH', 'NJ', 'NM', 'NV', 'NY', 'OH', 'OK', 'OR', 'PA', 'RI', 'SC', 'SD', 'TN', 'TX', 'UT', 'VA', 'VT', 'WA', 'WI', 'WV', 'WY'))
if state=="AK": 
...
if prediction:
	...
	if (int(cat) == False or int(sub_cat) ==False or int(city) ==False or int(state) ==False or float(goal) ==False or int(updates) ==False or int(level) ==False or int(duration) ==False):
		...
		if y_pred == 1:
			...
			st.markdown("<p style='margin: 0px 0px 0px 0px;text-align: justify;'>Looks like the project you are about to start is going be classifed as successful project. This means that the project will get the required funding and backing based on the previous year's data. Go ahead and start a new project. All the best</p>", unsafe_allow_html=True)
			...
			successful_project,failed_projects,avg_goal,avg_update,avg_duration,avg_level = project_recommendation(data)
			...
			statement1 = "Based on our recommendation engine's analysis, your goal should be between {} and {}". format(round(avg_goal*0.90,2), round(avg_goal*1.1,2))
			statement2 = "Based on our recommendation engine's analysis, number of updates you provide during the projects should be between {} and {}". format(int(avg_update), int(avg_update*1.1)+1)
			statement3 = "Based on our recommendation engine's analysis, duration of your project should be between {} and {}". format(int(avg_duration*90), int(avg_duration*1.1)+1)
			statement4 = "Based on our recommendation engine's analysis, number of levels for your projects should be between {} and {}". format(int(avg_level*0.9), int(avg_level*1.1)+1)
...
# 	open_statement = 'Previously, {} projects were posted based on your current selection of Category, Subcategory, State and City. Out of which {} projects were successfull and {} projects were failed.'.format(total_projects, successful_project, failed_projects)
# 	statement1 = "Based on our recommendation engine's analysis, your goal should be between {} and {}". format(avg_goal*0.90, avg_goal*1.1)
# 	statement2 = "Based on our recommendation engine's analysis, number of updates you provide during the projects should be between {} and {}". format(int(avg_update), int(avg_update*1.1)+1)
# 	statement3 = "Based on our recommendation engine's analysis, duration of your projetc should be between {} and {}". format(int(avg_duration*90), int(avg_duration*1.1)+1)
# 	statement4 = "Based on our recommendation engine's analysis, number of levels for your projects should be between {} and {}". format(int(avg_level*0.9), int(avg_level*1.1)+1)
